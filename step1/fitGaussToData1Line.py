...
plt.title("Spektrum 1. pixela")
plt.ylabel("Početnosť")
plt.xlabel("Energia ToT [ADU]")
plt.plot(x, y, color ="red", label="Nekalibrované ToT [ADU]")
# plt.plot(x, fitted_model(x), color ="blue", label="Gaussová krivka")
plt.legend()
plt.show()