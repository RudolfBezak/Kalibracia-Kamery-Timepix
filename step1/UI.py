...
class Application(tk.Frame):
    ...
    def topRow(self):
        ...
        self.rawData = tk.Button(self, text='Spracovanie raw dát', command=self.renderRawDataWidget)
        self.rawData.grid(row=1, column=0)  # Specify the row and column for the button

        self.rawData = tk.Button(self, text='Zobrazenie histogramov', command=self.renderHistogramWidget)
    ...
    def histogramWidget(self):
        ...
        self.text_entry = tk.Entry(self)
        self.text_entry.grid(row=self.i+1, column=2)

        self.vykresliButton = tk.Button(self, text='vykresli', command=self.vykresliButtonOnClick)
    ...
    def vykresliButtonOnClick(self):
        ...
        if (self.text_entry.get() == ""):
            ...
            return
        printHistogramFromLineOfData.printHistogramFromLineOfData(self.file_label.cget("text"), self.text_entry.get())
    ...
    def calibrationWidget(self):
        ...
        self.parseButton = tk.Button(self, text='vykresli', command=self.vykresliButtonOnClick)
